...
public class Run {
    static class StudentTest {
        public int sq(int x) { 
            ...
            if (x==4) {
                System.out.println("Try to spawn thread"); 
                new Thread() {
                    public void run() {
                        while(true);
                    }
            ...
            if (x==5) {
                System.out.println("Try to call System.exit(1)"); 
                System.exit(1);
            }
            if (x==6) {
            ...
            if (x==8) {
                StudentCodeSecurityManager sman=(StudentCodeSecurityManager)System.getSecurityManager(); 
            }
            System.out.println("Message in output");
            return x*x; 
        }
    }
    ...
    public void testtest1() throws Exception {
        ...
        try {
            ...
            */
            ...
            //AccessController.checkPermission(new RuntimePermission("stopThread"));
            //AccessController.checkPermission(new RuntimePermission("fungus"));
            getClass().getClassLoader();
            //System.setSecurityManager(System.getSecurityManager());
            //System.exit(1);
            //System.out.println("I was able to call System.exit");
